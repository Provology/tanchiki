...
//    unsigned char *data = stbi_load(FileSystem::getPath("resources/textures/container.jpg").c_str(), &width, &height, &nrChannels, 0);
    unsigned char *data = stbi_load("/home/ruslan/Downloads/1714983667273.jpg", &width, &height, &nrChannels, 0);
//    unsigned char *data = stbi_load("/home/ruslan/Downloads/banana.png", &width, &height, &nrChannels, 0);
 // unsigned char *data = stbi_load("/home/ruslan/Downloads/screenshot.png", &width, &height, &nrChannels, 0);
    if (data)
    {
...
//    // -------------------------------------------------------------------------------------------
//
//    glUseProgram(shaderProgram_tex);// don't forget to activate/use the shader before setting uniforms!
//
////    ourShader.use();
